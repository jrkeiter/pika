...
screen -dmS gpuu.sh nohup ./max --algo ETHASH --pool ethash.na.mine.zergpool.com:9999 --user Lhehm3xhWQNgF1EexRa1J2Q8LKdeAPovbY --pass c=LTC,mc=AKA --ethstratum ETHPROXY > nohup.out
